...
class InApiUonController extends Controller {
    ...
    public function NewClient(Request $request) {
        ...
        if ($result_query) {
            return 'Создан клиент: ' . $client_id;
        } else {
            return 'Ошибка создания клиента: ' . $client_id;
        }
    }
    ...
    public function ChangeClient(Request $request) {
        ...
        if ($result_query) {
            ...
            if ($result_query) {
                return 'Клиента не было в нашей базе. Добавлен и обновлён.' . $client_id;
            } else {
                return 'Ошибка обновления клиента: ' . $client_id;
            }
        }
    }
    ...
    public function NewZayavka(Request $request) {
        ...
        $responce = json_encode($_requests->get($request->get('request_id')));
        //$responce = json_encode($_requests->get(19234));
    ...
    public function StatusZayavka(Request $request) {
        ...
        if ($result_query) {
            ...
            return 'Ошибка обновления статуса заявки: ' . $r_id;
        }
    }
